...
| Build dataset-level orientation context | Initial file summaries, an extraction overview, and a compact dataset summary are generated and stored in workflow state. | Implemented. Used as orientation context, not source evidence. |
